...
// tag: "pyq" (verified past-year), "recreated" (paraphrase reconstructed from memory — verify if it matters),
//      "gen" (newly written, original)
// NOTE: given GATE's genuine year-attribution risk, most items below are tagged "recreated" rather than
...
const TOPICS = [
{
  ...
  questions: [
  Q("recreated","Sum of eigenvalues of a 3×3 matrix is 12, product is 20. Two eigenvalues are 2 and 4. The third is:",["2.5","6","4","10"],1,"Sum of eigenvalues = trace. 2+4+λ=12 → λ=6.","GATE CE 2016"),
  Q("gen","If rank(A)=2 for a 4×4 matrix A, nullity(A) is:",["0","1","2","4"],2,"Rank–nullity: rank+nullity=n=4 → nullity=2."),
  Q("recreated","A real symmetric matrix always has:",["Complex eigenvalues","Real eigenvalues; orthogonal eigenvectors for distinct λ","Real eigenvalues but never orthogonal eigenvectors","Only repeated eigenvalues"],1,"Spectral theorem: real symmetric ⇒ real eigenvalues, and eigenvectors of distinct eigenvalues are orthogonal.","GATE CE 2019"),
  ...
  Q("recreated","For A=[[2,0],[0,3]], eigenvector for λ=2 is:",["(1,0)","(0,1)","(1,1)","(1,-1)"],0,"A is diagonal; eigenvalues are diagonal entries, eigenvector for λ=2 is (1,0).","GATE CE 2021"),
  Q("gen","The determinant of a singular matrix is:",["1","-1","0","Undefined"],2,"A matrix is singular precisely when its determinant is 0."),
  Q("recreated","If A is 3×3 with det(A)=5, det(2A) equals:",["10","40","20","5"],1,"det(kA)=k^n det(A) for n×n matrix. Here n=3, k=2: 2³×5=40.","GATE CE 2014"),
  ...
  Q("recreated","Trace of a matrix equals:",["Product of eigenvalues","Sum of eigenvalues","Sum of diagonal minors","Determinant"],1,"Trace (sum of diagonal entries) always equals the sum of the eigenvalues.","GATE CE 2017"),
  Q("gen","For a 2×2 matrix with eigenvalues 3 and -2, det(A) equals:",["1","-6","6","-1"],1,"det(A) = product of eigenvalues = 3×(-2) = -6."),
  Q("recreated","The rank of a null (zero) matrix of any size is:",["Equal to its order","1","0","Undefined"],2,"A zero matrix has no non-zero rows/columns, so its rank is 0.","GATE CE 2012"),
  ...
  Q("recreated","An n×n matrix A is invertible if and only if:",["det(A)=0","rank(A)<n","det(A)≠0","A is symmetric"],2,"Invertibility ⇔ non-singular ⇔ det(A)≠0 ⇔ rank(A)=n.","GATE CE 2020"),
  ...
  Q("recreated","If Av=λv with v≠0, v is called:",["A basis vector","An eigenvector of A","A null vector","A unit vector"],1,"By definition, a non-zero v satisfying Av=λv is an eigenvector of A with eigenvalue λ.","GATE CE 2018"),
  ...
  Q("recreated","For a matrix A, (A^{-1})^{-1} equals:",["I","A","A^T","0"],1,"The inverse of the inverse returns the original matrix: (A^-1)^-1 = A.","GATE CE 2011"),
  ...
  Q("recreated","The characteristic equation of a 2×2 matrix A is λ²-5λ+6=0. The eigenvalues are:",["1,6","2,3","-2,-3","5,6"],1,"Factor: (λ-2)(λ-3)=0 → λ=2,3.","GATE CE 2015"),
  Q("gen","A square matrix A is idempotent if:",["A²=A","A²=I","A^T=A","A²=0"],0,"By definition, idempotent means A²=A."),
  Q("recreated","Cramer's rule for solving Ax=b requires:",["A to be singular","det(A)≠0","A to be symmetric","b=0"],1,"Cramer's rule is only applicable when det(A)≠0 (unique solution exists).","GATE CE 2013"),
  Q("gen","For matrix A=[[1,2],[2,4]], det(A) is:",["0","8","4","-4"],0,"det = 1×4 - 2×2 = 4-4 = 0 (rows are linearly dependent)."),
  Q("recreated","A matrix with all eigenvalues positive is called:",["Negative definite","Positive definite","Singular","Skew-symmetric"],1,"A symmetric matrix with all positive eigenvalues is positive definite.","GATE CE 2022"),
  ...
  Q("recreated","If A is orthogonal, det(A) equals:",["Only 1","Only -1","±1","0"],2,"Since AA^T=I, (det A)²=1, so det(A) = +1 or -1.","GATE CE 2019"),
  Q("gen","For A=[[0,1],[-1,0]], the eigenvalues are:",["1,-1","i,-i","0,0","2,-2"],1,"Char. eq: λ²+1=0 → λ=±i (complex, since A represents a rotation)."),
  Q("recreated","A square matrix A for which A²=0 (A≠0) is called:",["Idempotent","Nilpotent","Orthogonal","Involutory"],1,"A matrix with A^k=0 for some positive integer k (here k=2) is nilpotent.","GATE CE 2016"),
  ...
  Q("recreated","The sum of the eigenvalues of the identity matrix Iₙ is:",["0","1","n","n²"],2,"All n eigenvalues of Iₙ are 1, so their sum is n.","GATE CE 2010"),
...
},
{
  ...
  questions: [
  Q("recreated","lim(x→0) (sin 3x)/x equals:",["0","1","3","∞"],2,"= 3·lim (sin3x)/(3x) = 3×1 = 3.","GATE CE 2018"),
  Q("gen","f(x)=x³-3x has a local maximum at:",["x=-1","x=1","x=0","x=3"],0,"f'=3x²-3=0→x=±1; f''=6x; f''(-1)=-6<0 → local max at x=-1."),
  Q("recreated","Area between y=x² and y=4 is:",["16/3","32/3","8/3","4"],1,"Intersect at x=±2. Area=∫(4-x²)dx from -2 to2 = 32/3.","GATE CE 2015"),
  Q("gen","For f(x,y)=x²y+y³, ∂²f/∂x∂y at (1,2) is:",["2","4","1","6"],0,"∂f/∂y=x²+3y²; ∂/∂x of that = 2x = 2 at x=1."),
  Q("recreated","Taylor series of eˣ truncated to x² gives e^0.1 ≈:",["1.1000","1.1050","1.1052","1.1200"],1,"1+0.1+0.01/2 = 1.1050.","GATE CE 2020"),
  Q("gen","lim(x→0) (1-cos x)/x² equals:",["0","1","1/2","∞"],2,"Using series cos x≈1-x²/2: (1-cosx)/x² → 1/2."),
  Q("recreated","∫ x eˣ dx equals:",["eˣ(x-1)+C","eˣ(x+1)+C","xeˣ+C","eˣ+C"],0,"Integration by parts: ∫xeˣdx = xeˣ-∫eˣdx = xeˣ-eˣ+C = eˣ(x-1)+C.","GATE CE 2017"),
  ...
  Q("recreated","The radius of curvature is maximum where the curve is:",["Most curved","Straightest (flattest)","Undefined","At an inflection point only"],1,"Radius of curvature is inversely related to curvature; a flatter curve has larger radius of curvature.","GATE CE 2013"),
  Q("gen","∂z/∂x for z = x²+xy+y² at (1,1) is:",["2","3","4","1"],1,"∂z/∂x = 2x+y = 2(1)+1 = 3."),
  Q("recreated","The Mean Value Theorem requires f to be:",["Continuous on [a,b] and differentiable on (a,b)","Differentiable everywhere on R","Bounded only","Monotonic"],0,"MVT conditions: continuity on closed interval, differentiability on the open interval.","GATE CE 2016"),
  Q("gen","∫(0 to 1) x² dx equals:",["1/2","1/3","1","2/3"],1,"∫x²dx = x³/3, evaluated 0 to1 = 1/3."),
  Q("recreated","div(grad φ) is also written as:",["curl φ","∇²φ","∇×φ","φ²"],1,"The divergence of the gradient is the Laplacian, ∇²φ.","GATE CE 2019"),
  ...
  Q("recreated","∫∫ over region 0≤x≤1, 0≤y≤x of (x+y) dy dx equals:",["1/2","5/12","2/3","1/3"],0,"Inner: ∫0^x(x+y)dy = x²+x²/2=1.5x². Outer: ∫0^1 1.5x²dx = 0.5.","GATE CE 2012"),
  ...
  Q("recreated","The length of the curve y=x from x=0 to x=1 is:",["1","√2","2","1/2"],1,"Arc length = ∫√(1+(dy/dx)²)dx = ∫√2 dx from 0to1 = √2.","GATE CE 2011"),
  ...
  Q("recreated","∫ 1/(1+x²) dx equals:",["ln(1+x²)+C","tan⁻¹x+C","sin⁻¹x+C","1/(1+x²)²+C"],1,"Standard integral: ∫dx/(1+x²) = arctan(x)+C.","GATE CE 2014"),
  Q("gen","The volume under z=1 over the region 0≤x≤2, 0≤y≤3 is:",["5","6","1","12"],1,"Volume = area of base × height = (2×3)×1 = 6."),
  Q("recreated","lim(x→∞) (3x²+2)/(x²+5) equals:",["0","1","3","∞"],2,"Divide num & denom by x²: (3+2/x²)/(1+5/x²) → 3/1 = 3.","GATE CE 2021"),
  Q("gen","Divergence of vector field F=(x,y,z) is:",["0","1","3","x+y+z"],2,"div F = ∂x/∂x+∂y/∂y+∂z/∂z = 1+1+1 = 3."),
  Q("recreated","The point where f'(x)=0 and f''(x)=0 needs:",["No further test","Higher-order derivative test","Is always a maximum","Is always a minimum"],1,"When both first and second derivatives vanish, a higher-order test (e.g., third or fourth derivative) is needed to classify the point.","GATE CE 2015"),
  Q("gen","∫(0 to π) sin x dx equals:",["0","1","2","π"],2,"∫sinx dx = -cosx, evaluated 0 to π = -(-1)-(-1) = 2."),
  Q("recreated","The gradient vector ∇φ points in the direction of:",["Steepest decrease of φ","Steepest increase of φ","No change in φ","Along contour lines"],1,"By definition, ∇φ points toward the direction of maximum rate of increase of φ.","GATE CE 2018"),
  ...
  Q("recreated","∫ cos²x dx equals:",["x/2 + sin2x/4 + C","sin2x/2+C","x+C","cos2x/2+C"],0,"Using cos²x=(1+cos2x)/2: ∫ = x/2 + sin(2x)/4 + C.","GATE CE 2017"),
  ...
  Q("recreated","Stoke's theorem relates:",["A surface integral of curl F to a line integral of F","A volume integral to surface integral","Two volume integrals","Divergence to a scalar field"],0,"Stokes' theorem: ∮F·dr = ∫∫(curl F)·dA over the surface bounded by the curve.","GATE CE 2019"),
...
},
{
  ...
  questions: [
  Q("recreated","General solution of dy/dx + y = 0 is:",["y=Ceˣ","y=Ce^{-x}","y=Cx","y=C"],1,"Separable: dy/y=-dx → y=Ce^{-x}.","GATE CE 2017"),
  ...
  Q("recreated","Euler-Cauchy eqn x²y''+xy'-y=0 has y=xᵐ with m=",["1,-1","1,1","0,1","2,-2"],0,"Substituting gives m²-1=0 → m=±1.","GATE CE 2022"),
  Q("gen","IVP dy/dx=y, y(0)=1 gives y(1)=",["1","e","e²","2"],1,"y=eˣ (from ln y=x+c, c=0), y(1)=e."),
  Q("recreated","Which is a non-linear ODE?",["y''+3y'+2y=0","(y')²+y=x","y''+xy'=sinx","y'+y=eˣ"],1,"(y')² makes it non-linear (derivative raised to a power).","GATE CE 2014"),
  ...
  Q("recreated","d²y/dx²+4y=0 has general solution:",["C1cos2x+C2sin2x","C1e^{2x}+C2e^{-2x}","(C1+C2x)e^{2x}","C1cos4x"],0,"m²+4=0→m=±2i → oscillatory solution C1cos2x+C2sin2x.","GATE CE 2020"),
  ...
  Q("recreated","The particular integral of y''-y=eˣ (since eˣ solves the homogeneous part) has form:",["Aeˣ","Axeˣ","Ax²eˣ","A"],1,"Since eˣ solves the homogeneous equation (root m=1), PI is taken as Axeˣ (multiply by x for resonance).","GATE CE 2016"),
  ...
  Q("recreated","The solution of dy/dx = ky (k>0), y(0)=y0 models:",["Exponential decay","Exponential growth","Linear growth","No growth"],1,"y=y0e^{kt} with k>0 is exponential growth (e.g., population growth models).","GATE CE 2013"),
  ...
  Q("recreated","For d²y/dx² + ω²y = 0, the general solution represents:",["Exponential growth","Simple harmonic motion","Damped motion","Linear motion"],1,"This is the classic SHM equation; solution is C1cos(ωx)+C2sin(ωx).","GATE CE 2018"),
  ...
  Q("recreated","Bernoulli's equation dy/dx+Py=Qyⁿ is converted to linear form using substitution:",["v=y","v=y^{1-n}","v=y^n","v=1/y"],1,"Standard technique: divide by yⁿ and substitute v=y^{1-n} to linearize.","GATE CE 2015"),
  Q("gen","An exact ODE M dx + N dy = 0 satisfies:",["∂M/∂y = ∂N/∂x","M=N","∂M/∂x=∂N/∂y","M+N=0"],0,"Exactness condition: ∂M/∂y = ∂N/∂x."),
  Q("recreated","The Wronskian of two solutions y1,y2 of a linear 2nd order ODE is non-zero when:",["Solutions are dependent","Solutions are linearly independent","y1=y2","Never"],1,"A non-zero Wronskian confirms linear independence of the solution pair.","GATE CE 2019"),
  ...
  Q("recreated","In the equation y''+2y'+y=0, the roots of the auxiliary equation are:",["1,1","-1,-1","1,-1","2,2"],1,"m²+2m+1=0→(m+1)²=0→m=-1 (repeated).","GATE CE 2011"),
  ...
  Q("recreated","The equation (2x+y)dx+(x+2y)dy=0 is:",["Exact","Not exact","Linear only","Homogeneous only"],0,"∂M/∂y=1, ∂N/∂x=1 — equal, so the equation is exact.","GATE CE 2012"),
  ...
  Q("recreated","A linear ODE with variable coefficients reduced to constant coefficients by x=eᵗ is the:",["Bernoulli equation","Euler-Cauchy equation","Riccati equation","Clairaut equation"],1,"The Euler-Cauchy (equidimensional) equation is solved via x=eᵗ substitution.","GATE CE 2021"),
  ...
  Q("recreated","The particular integral of y''+y = sin x (since sinx is part of the homogeneous solution) takes the form:",["A sinx","Ax cosx (or similar x-multiplied form)","A","Ax²"],1,"Resonance case: since sinx solves the homogeneous eqn, PI includes a factor of x, e.g. Ax cosx + Bx sinx.","GATE CE 2016"),
  ...
  Q("recreated","For dy/dx = x² + y², separation of variables:",["Is directly applicable","Is not directly applicable (non-separable)","Gives a linear solution","Always fails"],1,"The RHS mixes x and y in a sum, not a product, so it cannot be separated directly.","GATE CE 2020"),
  ...
  Q("recreated","y=Ce^{-2x} is the general solution of:",["dy/dx=2y","dy/dx=-2y","dy/dx=-2x","d²y/dx²=-2y"],1,"Differentiating y=Ce^{-2x} gives y'=-2Ce^{-2x}=-2y.","GATE CE 2014"),
...
},
{
  ...
  Q("recreated","∂²φ/∂x²+∂²φ/∂y²=0 (Laplace) is:",["Elliptic","Parabolic","Hyperbolic","None"],0,"B²-4AC = 0-4(1)(1) = -4 <0 → elliptic.","GATE CE 2013"),
  ...
  Q("recreated","An odd function's Fourier series contains:",["Only cosine terms","Only sine terms","Both equally","Neither"],1,"Odd f(x): cosine coefficients vanish, leaving pure sine series.","GATE CE 2019"),
  ...
  Q("recreated","The general solution of the 1-D wave equation (D'Alembert's solution) is:",["u=f(x+ct)+g(x-ct)","u=f(x)g(t)","u=f(x²+t²)","u=f(x)/g(t)"],0,"D'Alembert's solution expresses u as the sum of two waves travelling in opposite directions.","GATE CE 2021"),
  ...
  Q("recreated","The heat equation ut=αuxx models:",["Wave propagation","Diffusion/heat conduction","Steady potential flow","Elastic vibration"],1,"This is the standard parabolic diffusion/heat-conduction equation.","GATE CE 2015"),
  ...
  Q("recreated","The period of a function's Fourier series over (-L,L) uses basis functions with argument:",["nπx/L","nx","2πx","x/n"],0,"Standard Fourier series on (-L,L) uses cos(nπx/L), sin(nπx/L).","GATE CE 2017"),
  ...
  Q("recreated","Neumann boundary conditions specify:",["The function value","The normal derivative of the function","Both function and derivative","Nothing"],1,"Neumann conditions prescribe the derivative (flux) at the boundary.","GATE CE 2018"),
  ...
  Q("recreated","2-D Laplace's equation in polar coordinates is used for problems with:",["Rectangular symmetry","Circular/cylindrical symmetry","No symmetry","Only 1-D domains"],1,"Polar form is natural for problems with circular boundaries (e.g., circular plates, pipes).","GATE CE 2012"),
  ...
  Q("recreated","A Fourier half-range sine series is used when the function is defined on:",["(-L,L) and even","(0,L) and extended as an odd function","(0,L) and extended as an even function","All of R"],1,"Half-range sine series arise from extending a function on (0,L) oddly about x=0.","GATE CE 2020"),
  ...
  Q("recreated","The equation uxx+uyy=f(x,y) (non-zero RHS) is called:",["Homogeneous Laplace","Poisson's equation","Wave equation","Heat equation"],1,"Laplace's equation with a non-zero source term is called Poisson's equation.","GATE CE 2016"),
  ...
  Q("recreated","Fourier coefficients a0, an, bn are computed using integrals of f(x) multiplied by:",["1, cos(nπx/L), sin(nπx/L) respectively","Only sin terms","Only exponential terms","Random weights"],0,"Standard Euler formulas for Fourier coefficients use these orthogonal basis functions.","GATE CE 2014")
  ]
},
{
  id: "prob-stats", name: "Probability and Statistics",
  questions: [
  Q("recreated","A fair die is rolled twice; P(sum=8) is:",["5/36","6/36","1/6","4/36"],0,"Favorable pairs: (2,6)(3,5)(4,4)(5,3)(6,2) = 5 of 36.","GATE CE 2020"),
  Q("gen","Median of {4,8,6,5,3,7} is:",["5","5.5","6","6.5"],1,"Sorted: 3,4,5,6,7,8. Median=(5+6)/2=5.5."),
  Q("recreated","≈95% of a normal distribution lies within:",["μ±1σ","μ±2σ","μ±3σ","μ±0.5σ"],1,"Empirical rule: 68-95-99.7 for 1,2,3 standard deviations.","GATE CE 2016"),
  Q("gen","For independent X,Y: E[XY] equals:",["E[X]E[Y]","E[X]+E[Y]","0","Cov(X,Y)"],0,"Independence implies E[XY]=E[X]E[Y]."),
  Q("recreated","Vehicle arrivals at a toll booth are best modeled by:",["Normal","Poisson","Uniform","Binomial(n=2)"],1,"Poisson models counts of independent random events in a fixed interval.","GATE CE 2022"),
  Q("gen","Variance of a constant c is:",["c","c²","0","1"],2,"A constant has no spread, so Var(c)=0."),
  Q("recreated","For a Binomial(n,p) distribution, the mean is:",["np","np(1-p)","p/n","n/p"],0,"Standard result: mean of Binomial(n,p) = np.","GATE CE 2015"),
  ...
  Q("recreated","The standard normal distribution has mean and variance:",["0 and 1","1 and 0","0 and 0","1 and 1"],0,"By definition, the standard normal Z has μ=0, σ²=1.","GATE CE 2013"),
  ...
  Q("recreated","Bayes' theorem is used to find:",["Joint probability only","Posterior probability given prior and likelihood","Variance only","Mean only"],1,"Bayes' theorem updates a prior probability using observed evidence (likelihood) to get a posterior.","GATE CE 2018"),
  ...
  Q("recreated","Two dice are rolled; P(both show the same number) is:",["1/6","1/36","6/36","5/36"],0,"6 favorable outcomes out of 36 → 1/6.","GATE CE 2011"),
  ...
  Q("recreated","For events A, B: P(A|B) = ",["P(A∩B)/P(B)","P(A)P(B)","P(A∪B)/P(B)","P(B)/P(A)"],0,"Definition of conditional probability.","GATE CE 2017"),
  Q("gen","If Var(X)=4, the standard deviation of X is:",["2","4","16","8"],0,"Standard deviation = √variance = √4 = 2."),
  Q("recreated","In a normal Q-Q plot, points falling on a straight line suggest:",["Data is skewed","Data is approximately normal","Data has outliers only","No relationship"],1,"A linear Q-Q plot against normal quantiles indicates the data closely follows a normal distribution.","GATE CE 2021"),
  Q("gen","The range of a data set {2,9,4,7,3} is:",["7","9","5","2"],0,"Range = max - min = 9 - 2 = 7."),
  Q("recreated","For a Poisson distribution with mean λ=4, the variance is:",["2","4","16","8"],1,"Poisson's defining property: variance = mean = λ = 4.","GATE CE 2014"),
  ...
  Q("recreated","The correlation coefficient r always lies in the range:",["[0,1]","[-1,1]","(-∞,∞)","[0,∞)"],1,"Pearson's correlation coefficient is bounded between -1 and 1.","GATE CE 2019"),
  ...
  Q("recreated","If two events A and B are independent, then A and complement of B are:",["Dependent","Also independent","Mutually exclusive","Identical"],1,"Independence of A and B implies independence of A and B' as well.","GATE CE 2012"),
  ...
  Q("recreated","For a uniform distribution on [a,b], the variance is:",["(b-a)²/12","(b-a)/2","(b-a)²/4","(a+b)/2"],0,"Standard result for continuous uniform distribution: Var = (b-a)²/12.","GATE CE 2016"),
...
},
{
  ...
  questions: [
  Q("recreated","Trapezoidal rule (n=2,h=1) for ∫(0 to2)x²dx using x=0,1,2 gives:",["2.0","2.5","3.0","8/3"],2,"h/2[f0+2f1+f2]=0.5[0+2+4]=3.0 (exact value is 8/3≈2.667; trapezoidal overestimates for convex f).","GATE CE 2015"),
  ...
  Q("recreated","Order of convergence of Newton-Raphson (simple root) is:",["Linear","Quadratic","Cubic","None"],1,"For a simple root with f'≠0, NR converges quadratically.","GATE CE 2018"),
  ...
  Q("recreated","Lagrange interpolation through n+1 points gives a polynomial of degree at most:",["n","n+1","n-1","2n"],0,"Given n+1 points, the unique interpolating polynomial has degree ≤ n.","GATE CE 2021"),
  ...
  Q("recreated","Simpson's 1/3 rule with h=1 over [0,4] (x=0,1,2,3,4) for ∫x²dx gives:",["64/3","21.0","20.0","22.0"],0,"h/3[f0+4(f1+f3)+2f2+f4] = 1/3[0+40+8+16]=64/3≈21.33.","GATE CE 2019"),
  ...
  Q("recreated","Gauss elimination method solves a system of linear equations by:",["Iterative substitution only","Reducing the augmented matrix to row-echelon form","Computing eigenvalues","Matrix inversion only"],1,"Gauss elimination reduces the system to upper-triangular form, then back-substitutes.","GATE CE 2014"),
  ...
  Q("recreated","In Newton-Raphson, if f'(x) is close to zero near the root, the method may:",["Converge faster","Diverge or converge slowly/erratically","Always converge quadratically","Be unaffected"],1,"A small derivative causes large steps and potential divergence.","GATE CE 2020"),
  ...
  Q("recreated","Gauss-Seidel method is a technique to solve systems of equations:",["Directly, in one step","Iteratively, using updated values within each iteration","Only for 2x2 systems","Only for singular matrices"],1,"Gauss-Seidel uses the latest updated values immediately within the same iteration, generally converging faster than Jacobi.","GATE CE 2017"),
  ...
  Q("recreated","The number of iterations for bisection to reach tolerance ε from interval width L is approximately:",["log2(L/ε)","L/ε","ε/L","Independent of L and ε"],0,"Since bisection halves the interval each step, n ≈ log2(L/ε).","GATE CE 2016"),
  ...
  Q("recreated","Interpolation is used to:",["Extrapolate far beyond given data reliably","Estimate values within the range of given data points","Solve differential equations directly","Find eigenvalues"],1,"Interpolation estimates values between known data points; extrapolation beyond the range is generally less reliable.","GATE CE 2013"),
  ...
  Q("recreated","Numerical differentiation using forward difference has truncation error of order:",["O(h)","O(h²)","O(h³)","Exact, no error"],0,"The simple forward-difference formula has first-order (O(h)) truncation error.","GATE CE 2012")
  ]
}
];
...
window.DATA = { TOPICS, GA_QUESTIONS, ADDITIONAL, MOCK_1 };
